...
set rc [catch {
  ...
  report_drc -file hdmi_in_wrapper_drc_routed.rpt -pb hdmi_in_wrapper_drc_routed.pb -rpx hdmi_in_wrapper_drc_routed.rpx
  report_methodology -file hdmi_in_wrapper_methodology_drc_routed.rpt -rpx hdmi_in_wrapper_methodology_drc_routed.rpx
