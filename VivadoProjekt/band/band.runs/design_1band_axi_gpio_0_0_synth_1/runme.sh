...
HD_PWD='C:/Projects/jan2017/VivadoProjekt/band/band.runs/design_1band_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1band_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1band_axi_gpio_0_0.tcl
