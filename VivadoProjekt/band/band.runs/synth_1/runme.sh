...
HD_PWD='C:/Projects/jan2017/VivadoProjekt/band/band.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1band_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1band_wrapper.tcl
