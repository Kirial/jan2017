...
HD_PWD='C:/Projects/jan2017/VivadoProjekt/band/band.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1band_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_1band_wrapper.tcl -notrace
