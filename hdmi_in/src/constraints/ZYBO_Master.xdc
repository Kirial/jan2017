...
##IO_L3N_T0_DQS_34
set_property PACKAGE_PIN V13 [get_ports {gpio_io_i[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_io_i[4]}]

##IO_L9N_T1_DQS_34
set_property PACKAGE_PIN U17 [get_ports {gpio_io_i[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_io_i[5]}]

##IO_L20P_T3_34
set_property PACKAGE_PIN T17 [get_ports {gpio_io_i[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_io_i[6]}]

##IO_L7N_T1_34
set_property PACKAGE_PIN Y17 [get_ports {gpio_io_i[7]}]
